...
<html>
    <head>
        ...
        <script>
            ...
            function openEditPopup(threadId) {
                var popup = document.getElementById("editPopup_" + threadId);
                popup.style.display = "block";
            }

            function closeEditPopup(threadId) {
                var popup = document.getElementById("editPopup_" + threadId);
                popup.style.display = "none";
            }

            // Get updated thread information from URL
            var urlParams = new URLSearchParams(window.location.search);
            var updatedThreadId = urlParams.get('tId');
            var updatedContent = decodeURIComponent(urlParams.get('content'));

            // Apply updated content to the corresponding thread
            var threadContentElement = document.querySelector(`#thread_${updatedThreadId} .p-2 p.text-justify`);
            if (threadContentElement)
            {
                threadContentElement.textContent = updatedContent;
            }
            ...
            function commentOp(commentId) {
                ...
                var divElement2 = document.getElementById('comment2_' + commentId);
                if (divElement) {
                    divElement.style.display = "block";
            ...
            function submitForm() {
                var form = document.getElementById('form_sort');
                form.submit();
            }
        </script>
    </head>
        ...
        <div class="container rounded mt-4 my-5">
            ...
            <section id="featured-section" class="section rounded-3" style="margin-top: 80px">
                ...
                <div class="container py-5" style="display:flex;flex-direction: column;">
                    <div class="row">
                        <div class="col">
                            <nav aria-label="breadcrumb" class=" rounded-3 p-3 mb-4" style="max-width: 1020px">
                    ...
                    <div style="display:flex;justify-content: space-evenly;">
                        ...
                        <div class="col-lg-8 text-black rounded-3" style="height: 262.73px;width: 700px;">
                            <div class="card mb-4">
                                <div class="card-body position-relative py-3 px-4" style="height: 262.73px; background-color: #dddddd;">
                                    <div class="row">
                                        <div class="col-sm-3">
                                    ...
                                    <c:if test="${!HasEnd}">
                                        <a href="vote?id=${c.getId()}" class="btn btn-dark position-absolute bottom-0 end-0 mx-3 mb-3">Vote</a>
                                    </c:if>
                                    <c:if test="${HasEnd}">
            ...
            <section id="candidate-section row py-2 text-center bg-light" class="section rounded-3">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <p class="card-text"><span class="badge text-black"><strong>${vote.getPointByCandidateId(v.getVotingObjectId())}</strong></span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="text-center">
                    <a href="campaign_statistics?campaignId=${c.getId()}" class="btn btn-dark w-25 text-center <c:if test="${noOfVotes.get(0).getKey()==0}"> disabled </c:if> ">Campaign Statistics</a>
                    </div>
                </section>  
                <!-- End of Candidates -->
                ...
                <section id="post-section" class="section rounded-3 text-black">
                    ...
                    <form action="ViewCampaignDetails" method="post" >
                        <div class="form-floating d-flex flex-column align-items-center">
                            <textarea class="form-control bg-light" name="content" placeholder="What do you think?" style="height: 100px; resize: none;"></textarea>
                            <label for="floatingTextarea2">What do you think?</label>
                            <input type="hidden" name="Cid" value="${Cid}">
                            <button class="btn-dark btn my-2 ">Post</button>
                        </div>
                    </form>  
                </section>
            </c:if>
            <c:if test="${HasEnd}">
                <section id="post-section" class="section rounded-3 text-black" style="display: none">
                    <!-- Posting new thread -->
                    <form action="ViewCampaignDetails" method="post" >
                        <div class="form-floating d-flex flex-column align-items-center">
                                ...
                                <div class="card" style="background-color: #dddddd;" >
                                    <div class="d-flex justify-content-between p-2 px-3">
                                        <div class="d-flex flex-row align-items-center">
                                            <img src="images\ava.png" width="50" class="rounded-circle">
                                            <div class="d-flex flex-column ml-2">
                                                <span class="name font-weight-bold mx-2">${a.getNameById(Tdata.getAccountId())}</span>
                                                <small class="mr-2 mx-2 ellipsis">${Tdata.getTimeCreate()}</small>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-row mt-1 ellipsis">
                                            <c:if test="${Tdata.isIsPinned() == true}">
                                            ...
                                            <c:if test="${Tdata.getAccountId() == a.getId() || a.isIsAdmin()}">
                                                ...
                                                <div>
                                                    <div class="modal fade" id="editModal_${Tdata.getThreadId()}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel_${Tdata.getThreadId()}" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="editModalLabel_${Tdata.getThreadId()}">Edit</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <form id="editForm_${Tdata.getThreadId()}" action="EditThreadController" method="post">
                                                                        <input type="hidden" name="threadId" value="${Tdata.getThreadId()}">
                                                                        <input type="hidden" name="Cid" value="${Cid}">
                                                                        <textarea name="content" class="form-control">${Tdata.getContent()}</textarea>
                                                                        ...
                                                                        <a class="text-decoration-none btn-edit text-muted" data-toggle="modal" data-target="#editModal_${Tdata.getThreadId()}" >Edit</a>
                                                    <a class="text-decoration-none delete-btn text-muted" onclick="deleteThread(event, ${Tdata.getThreadId()})">Delete</a>
                                                </div>
                                            </c:if>
                                        </div>
                                    ...
                                    <div class="p-2">
                                        <strong class="text-justify" style="font-size: 20px;">${Tdata.getContent()}</strong>
                                    </div>
                                    <div>
                                        ...
                                        <a href="#!" style="text-decoration: none; margin-left: 5px;">
                                            <button id="likeBtn_${threadId}" onclick="like(${threadId})" class="btn btn-outline-primary likeBtn <c:if test="${Tdata.isLiked(accountId, Tdata.getThreadId())}">liked</c:if>">
                                                Like <span id="likeCountElement_${threadId}">${likeCount}</span>
                                            </button>
                                        </a>
                                        <a href="#!" style="text-decoration: none;">
                                            <button id="dislikeBtn_${threadId}" onclick="dislike(${threadId})" class="btn btn-outline-danger dislikeBtn <c:if test="${Tdata.isDisliked(accountId, Tdata.getThreadId())}">disliked</c:if>">
                                        ...
                                        <c:forEach items="${commentList}" var="comment">
                                            <c:if test ="${comment.getThreadId() == Tdata.getThreadId() && comment.getParentCommentId() == 0}">
                                                <div class="d-flex flex-row mb-2"> 
                                                    <img src="images\ava.png" alt="avatar" width="40" height="40" class="rounded-image ms-2">
                                                    <div class="d-flex flex-column ml-2 mx-2"> 
                                                        ...
                                                        <div class="comment-text d-flex flex-column">
                                                            <p class="ms-2" style="font-size: 16px;">${comment.getContent()}  </p>
                                                            ...
                                                            <c:if test ="${a.getId() == comment.getAccountId()}">
                                                                ...
                                                                <form id="comment2_${comment.getCommentId()}" action="deleteComment" method="post" style="display: none">
                                                                    <input type ="hidden" name ="commentID" value = "${comment.getCommentId()}">
                                                                    <input type="hidden" name="accountID" value="${a.getId()}">
                                                                    <input type="hidden" name="Cid" value="${Cid}">
                                                        ...
                                                        <small>
                                                            ...
                                                            <c:set var="likeCountCmt" value="${comment.getLikeByCommentId(commentId)}" />
                                                            <c:set var="dislikeCountCmt" value="${comment.getDislikeByCommentId(commentId)}" />
                                                            <button id="likeCmtBtn_${commentId}" onclick="likeCmt(${commentId}, ${threadId})" style="border: none; background-color: transparent" class="likeBtn <c:if test="${comment.isLiked(accountId, commentId)}">liked</c:if>"> </button>
<!--                                                                <span id="likeCountCmtElement_${commentId}" >${likeCountCmt}</span>-->
                                                            <button id="dislikeCmtBtn_${commentId}" onclick="dislikeCmt(${commentId}, ${threadId})" style="border: none; background-color: transparent" class="dislikeBtn <c:if test="${comment.isDisliked(accountId, commentId)}">disliked</c:if>"> </button>
<!--                                                                <span id="dislikeCountCmtElement_${commentId}" >${dislikeCountCmt}</span>-->
                                                        </small> 
                                                        ...
                                                        <div class="d-flex flex-row align-items-center status"> 
                                                            ...
                                                            <form action="ReplyCommentController" method="post">
                                                                ...
                                                                <div id="reply-input-${comment.getCommentId()}" style="display: none;">
                                                                    ...
                                                                    <button class="btn btn-dark submit-reply-btn">Reply</button>
                                                                </div>
                                                            </form>
                                                            ...
                                                            <c:if test="${reply.getParentCommentId() == comment.getCommentId()}">
                                                                <div class="d-flex flex-row mb-2"> 
                                                                    ...
                                                                    <div class="d-flex flex-column ml-2 mx-2"> 
                                                                        ...
                                                                        <small style="font-size: 16px;" class="comment-text">${reply.getContent()}</small>
                                                                        <small>
                                                                            <c:set var="replyId" value="${reply.getCommentId()}" />
                                                                            <c:set var="likeCountReply" value="${reply.getLikeByCommentId(replyId)}" />
                                                                            <c:set var="dislikeCountReply" value="${reply.getDislikeByCommentId(replyId)}" />
                                                                            <c:if test="${reply.getParentCommentId() != null}">
                                                                                <button id="likeCmtBtn_${replyId}" onclick="likeCmt(${replyId}, ${threadId})" style="border: none; background-color: transparent" class="likeBtn <c:if test="${reply.isLiked(accountId, replyId)}">liked</c:if>">Like <span id="likeCountCmtElement_${replyId}" >${likeCountReply}</span></button>
                                                                                <button id="dislikeCmtBtn_${replyId}" onclick="dislikeCmt(${replyId}, ${threadId})" style="border: none; background-color: transparent" class="dislikeBtn <c:if test="${reply.isDisliked(accountId, replyId)}">disliked</c:if>">Dislike <span id="dislikeCountCmtElement_${replyId}" >${dislikeCountReply}</span></button>
                                                                                </c:if>
                                                                        </small>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="d-flex flex-row align-items-center status"> 
                                                                    ...
                                                                    <form action="ReplyCommentController" method="post">
                                                                        ...
                                                                        <div id="reply-input-${reply.getCommentId()}" style="display: none;">
                                                                            <input type="text" name="replyContent" class="form-control" placeholder="Write a reply">
                                                                            <button class="btn btn-dark submit-reply-btn mt-3">Reply</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                        ...
                                        <form action="CommentController" method="post">
                                            <div class="comment-input"> 
                                                ...
                                                <input type="hidden" name="accountID" value="${a.getId()}">
                                                <input type="hidden" name="threadID" value="${Tdata.getThreadId()}">
                                                <textarea class="form-control bg-light" name="Content" id="textAreaExample" rows="1" placeholder="Write a comment..." style="resize: none;"></textarea>
                                                <button type="submit" class="btn btn-dark float-end my-1 mx-1">Comment</button>
                                            </div>
                                        </form>
            ...
            <script>
                ...
                function saveAndReload(threadId) {
                    var form = document.getElementById("editForm_" + threadId);
                    form.submit();
