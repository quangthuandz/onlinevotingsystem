...
public class DeleteCommentController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String type = request.getParameter("CmtType");
        System.out.println("Type = " + type);
        //delete the notification before.
        n.DeleteCommentRelatedNotification(Tid,id, type);
        CommentPost c = new CommentPost(id, Tid);
        c.DeleteComment();
